...
public class ConceptReferenceUtil {
    ...
    public static ConceptReference toSDMXReference(sdmx.gateway.entities.ConceptReference con) {
        return ConceptReference.create(new NestedNCNameID(con.getConcept().getConceptPK().getAgencyId()), new IDType(con.getConcept().getConceptPK().getId()), new Version(con.getConcept().getConceptPK().getVersion()), new IDType(con.getConcept().getConceptPK().getId()));
    }
