...
public class MeasureStructureComponentPK implements Serializable {
    ...
    public MeasureStructureComponentPK(String id, String version, String agencyID, String componentId) {
        this.id = id;
    ...
    public String toString() {
        return "sdmx.gateway.entities.MeasureStructureComponentPK[ id=" + id + ", version=" + version + ", agencyID=" + agencyID + ", componentId=" + componentId + " ]";
    }
