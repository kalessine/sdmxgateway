 ...
 */
@Embeddable
public class MeasureStructureComponentPK implements Serializable {
    ...
    public MeasureStructureComponentPK() {
    }

    public MeasureStructureComponentPK(String agencyID, String id, String version, String componentId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MeasureStructureComponentPK)) {
            return false;
        }
        MeasureStructureComponentPK other = (MeasureStructureComponentPK) object;
    ...
    public String toString() {
        return "sdmx.gateway.entities.MeasureStructureComponentPK[ agencyID=" + agencyID + ", id=" + id + ", version=" + version + ", componentId=" + componentId + " ]";
    }
