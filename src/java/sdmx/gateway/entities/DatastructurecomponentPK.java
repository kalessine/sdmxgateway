...
public class DatastructurecomponentPK implements Serializable {
    ...
    public DatastructurecomponentPK(String dataStructureAgencyID, String dataStructureID, String dataStructureVersion, int position) {
    ...
    public String toString() {
        return "sdmx.gateway.entities.DatastructurecomponentPK[ dataStructureAgencyID=" + dataStructureAgencyID + ", dataStructureID=" + dataStructureID + ", dataStructureVersion=" + dataStructureVersion + ", position=" + position + " ]";
    }
