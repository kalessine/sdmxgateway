 ...
 */
@Embeddable
public class TimeStructureComponentPK implements Serializable {
    ...
    public TimeStructureComponentPK() {
    }

    public TimeStructureComponentPK(String id, String version, String agencyID, String componentId) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TimeStructureComponentPK)) {
            return false;
        }
        TimeStructureComponentPK other = (TimeStructureComponentPK) object;
    ...
    public String toString() {
        return "sdmx.gateway.entities.TimeStructureComponentPK[ id=" + id + ", version=" + version + ", agencyID=" + agencyID + ", componentId=" + componentId + " ]";
    }
