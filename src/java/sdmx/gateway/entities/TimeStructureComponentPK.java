...
public class TimeStructureComponentPK implements Serializable {
    ...
    public TimeStructureComponentPK(String agencyID, String id, String version, String componentId) {
    ...
    public String toString() {
        return "sdmx.gateway.entities.TimeStructureComponentPK[ agencyID=" + agencyID + ", id=" + id + ", version=" + version + ", componentId=" + componentId + " ]";
    }
