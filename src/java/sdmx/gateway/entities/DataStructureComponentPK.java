...
public class DataStructureComponentPK implements Serializable {
    ...
    public DataStructureComponentPK(String id, String version, String agencyID, String componentId) {
        this.id = id;
    ...
    public String toString() {
        return "sdmx.gateway.entities.DataStructureComponentPK[ id=" + id + ", version=" + version + ", agencyID=" + agencyID + ", componentId=" + componentId + " ]";
    }
