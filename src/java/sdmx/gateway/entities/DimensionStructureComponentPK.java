...
public class DimensionStructureComponentPK implements Serializable {
    ...
    public DimensionStructureComponentPK(String agencyID, String id, String version, String componentId) {
    ...
    public String toString() {
        return "sdmx.gateway.entities.DimensionStructureComponentPK[ agencyID=" + agencyID + ", id=" + id + ", version=" + version + ", componentId=" + componentId + " ]";
    }
