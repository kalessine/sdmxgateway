 ...
 */
@Embeddable
public class DimensionStructureComponentPK implements Serializable {
    ...
    public DimensionStructureComponentPK() {
    }

    public DimensionStructureComponentPK(String id, String version, String agencyID, String componentId) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DimensionStructureComponentPK)) {
            return false;
        }
        DimensionStructureComponentPK other = (DimensionStructureComponentPK) object;
    ...
    public String toString() {
        return "sdmx.gateway.entities.DimensionStructureComponentPK[ id=" + id + ", version=" + version + ", agencyID=" + agencyID + ", componentId=" + componentId + " ]";
    }
